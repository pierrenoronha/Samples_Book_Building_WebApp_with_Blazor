...
{
    public partial class ComponentLifeCicle : ComponentBase
    {
        
        [Parameter]
        public string Name { get; set; } = "Should be rewrited by parameter";

        [Parameter]
        public string Title { get; set; } = "Component Life Cicle. ComponentLifeCicle.cs";
        
        private string _className = nameof(ComponentLifeCicle);
